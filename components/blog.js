    ...
    return (
        <article className="blog">
            ...
            <div className="blog__description">
                <p className="blog__category">#HTML #CSS #responsive</p>
                <h2>Recipe Blog</h2>
                ...
                <div className="blog__buttons__link">
                    <button className="btn btn-blue"><a href="https://interior-consultant-mjk.netlify.app/">Demo</a></button>
                    <button className="btn btn-white"><a href="https://github.com/moro-patana/interior-consultant">Code</a></button>
                </div>
            </div>
